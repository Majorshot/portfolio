...
/>
  ...
  threshold={0.1}
>
  <div><h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-[#40ffaa] via-[#4079ff] to-[#4079ff] bg-clip-text text-transparent">
              Get in Touch
            </h2>
      ...
      <div className="bg-gray-900 p-8 rounded-lg">
              ...
              {currentStep === 1 && (
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold text-cyan-300 mb-4">Your Info</h3>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
              ...
              {currentStep === 2 && (
                <div>
                  <h3 className="text-2xl font-bold text-cyan-300 mb-4">Message</h3>
                  <textarea
                    name="message"

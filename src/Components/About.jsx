...
const About = () => {
  return (
    <div
      id="about"
      className="bg-black text-white px-4 sm:px-6 md:px-10 py-10 sm:py-16 md:py-20"
    >
          ...
          >
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-300">
                As a Full Stack Developer specializing in the MERN stack, I
                bridge the gap between innovative design and seamless
                functionality. My expertise spans across MongoDB, Express.js,
                React.js, and Node.js, allowing me to craft end-to-end solutions

    ...
    <nav className="fixed top-0 w-full z-50">
      ...
      <div className="flex justify-between items-center bg-black/25 backdrop-blur-md text-white px-8 py-4 border-b border-white/10">
        ...
        <ul className="hidden md:flex items-center space-x-8">
          ...
          <li>
            <a href="#projects" className="hover:text-cyan-400 transition-colors duration-300">Services</a>
          </li>
          <li>
        ...
        {/* Contact Button */}
        <button className="hidden md:block border border-white/20 text-white px-6 py-2 rounded-full 
      ...
      <div className={`md:hidden bg-black/25 backdrop-blur-md border-b border-white/10 
        transition-all duration-300 ${isOpen ? 'max-h-64' : 'max-h-0 overflow-hidden'}`}>
        <ul className="flex flex-col text-white items-center space-y-4 py-4">
          ...
          <li>
            <button className="border border-white/20 text-white px-6 py-2 rounded-full 

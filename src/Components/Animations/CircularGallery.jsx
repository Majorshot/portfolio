...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: carrom, text: 'Carrom Comp' },
      { image: gentle, text: 'Awareness' },
      { image: net, text: 'Brand ad' },
      { image: sandwich, text: 'Menu Card' },
      { image: push, text: 'PushUp Comp' },
      { image: dust, text: 'Color Code' },
      { image: flow, text: 'FlowChart' },
      { image: keep, text: 'Cleaning' },
    ]

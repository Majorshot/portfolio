...
const Skill = () => {
  ...
  return (
    <div
      id="skills"
      className="bg-black text-white py-10 sm:py-16 lg:py-20 px-4 sm:px-8 lg:px-20"
    >
      {/* Header */}
        ...
        >
          <div>
            <p className="text-base sm:text-lg lg:text-xl text-gray-300 max-w-2xl text-center leading-relaxed">
              Passionate about creating seamless web experiences with MERN
              stack, capturing life's moments through photography, and staying
              ahead with the latest tech trends. Here's a glimpse of my
              ...
              <div>
                <div className="flex flex-row items-center justify-between px-4">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    />
                    <p className="text-xs sm:text-base lg:text-lg text-gray-300 mt-2">
                      {" "}
                      Trusted Clients
                    </p>
                  </div>
